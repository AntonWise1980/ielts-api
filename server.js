...
app.get('/api/data', async (req, res) => {
    ...
    try {
        ...
        connection = await mysql.createConnection({
            ...
            // YENİ: JSON alanlarını otomatik parse et (mysql2 için)
            typeCast: function (field, next) {
        if (field.type === 'JSON') {
            const val = field.string('utf8'); // UTF-8 encoding zorunlu!
        ...
        // YENİ: synonyms ve antonyms her zaman array olsun (güvenlik için)
